...
import deleteExaminationAPI from "./utils/handleExaminationDeletion";
import UpdateExamnation from "./UpdateExaminationsPage";
import fetchDisplayExamination from "./utils/fetchDisplayExaminations";
...
const DisplayExaminationsDetails = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const result = await fetchDisplayExamination();
