...
import fetchDeletereportTypeByIdAPI from "./utils/fetchDeletereportTypeByIdAPI";
import UpdateReportTypePage from "./UpdateReportTypePage";
import fetchDisplayReportTypes from "./utils/fetchDisplayReportTypes";
...
const DisplayReportTypes = () => {
  ...
  const fetchData = async () => {
    try {
      const result = await fetchDisplayReportTypes();
      setData(result);
    } catch (error) {
